...
◊(define-meta tags "calibri,kindle,gmail")

So you’ve had your ◊link["http://www.amazon.com/Kindle-Wireless-Reader-Wifi-Graphite/dp/B002Y27P3M?ie=UTF8&tag=joelsimprpers-20&link_code=btl&camp=213689&creative=392969"]{Kindle} for a few months now, and it’s been sitting in your pack, unused for the last few weeks. What happened? Here’s how can you get more use out of this gadget you used to be so excited about.
...
◊ol{
◊li{To put an ebook on my Kindle, I email it to my ◊code{free.kindle.com} address (a snap since Gmail accepts drag-and-drop attachments). Presto, book appears on my Kindle.}
◊li{When I’m done with a book, I either delete it from my Kindle or put it in a “Finished” folder in my Kindle.}
◊li{Gmail keeps a copy of the file in the email attachment in case I ever need it. (I also stick them in a folder on my computer.)}
}
...
◊ul{
◊li{◊link["http://delivereads.com/"]{Delivereads} – This is a new one, and it’s just the kind of thing I’m looking for: free, high-quality stories delivered automatically to your Kindle, roughly once a week. This one is almost a no-brainer.}
◊li{◊link["http://instapaper.com"]{Instapaper} – Even though Instapaper is ◊link["http://notely.blogspot.com/2011/05/instapaper-auto-send-to-kindle-not.html"]{having some problems with automatic deliveries} at the moment (which will probably be fixed before too long), if you do any browsing on the Internet in the course of a normal day, Instapaper makes a great way to collect long articles for later reading. Just try and use it as a stash for things you already run across; don’t start crawling the web just to look for Kindle material – you’re trying to get away from that, remember?}
◊li{Newspaper subscriptions: Try a subscription to the ◊link["http://www.amazon.com/The-New-York-Times/dp/B000GFK7L6?ie=UTF8&tag=joelsimprpers-20&link_code=btl&camp=213689&creative=392969"]{New York Times} or the ◊link["http://www.amazon.com/The-Wall-Street-Journal/dp/B000FDJ0FS?ie=UTF8&tag=joelsimprpers-20&link_code=btl&camp=213689&creative=392969"]{Wall Street Journal}. Currently the reviews are very mixed; as of today you can see that not everyone finds these subscriptions worth the cost compared to the print editions. It will depend on the publication and whether you have the time to read all the issues.}
}
