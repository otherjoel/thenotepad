...
◊ol{
◊li{DropBox has had ◊link["http://techcrunch.com/2011/06/20/dropbox-security-bug-made-passwords-optional-for-four-hours/"]{security issues} that left users’ information exposed to hackers for hours at a time. Could it happen again? Certainly.}
◊li{DropBox staff ◊link["http://www.wired.com/threatlevel/2011/05/dropbox-ftc/"]{have the ability to access your files} without your knowledge. They have acknowledged that essentially the only thing between their staff and your data are internal company policies. This is much weaker than zero-knowledge systems like SpiderOak, where it is not even technically possible for staff to access users’ files without the user’s key.}
}
...
◊li{TrueCrypt volumes need to be given a fixed size at the time of creation, forcing you to guess how big it’ll need to be in the future and usually resulting in wasted space.}
...
◊li{The software has limited compatibility with the open-source EncFS encrypted file system, making it at least somewhat future-proof}
...
◊li{No form of plausible deniability is available in either the desktop or mobile versions of the software.}
