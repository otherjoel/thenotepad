...
◊(define-meta tags "iOS,iphone,calendars,apps")
...
◊li{The other really good option out there is ◊link["http://lifehacker.com/5833969/the-best-calendar-app-for-iphone"]{Week Calendar}. I haven’t tried it personally, but this one has been ◊link["http://lifehacker.com/5833969/the-best-calendar-app-for-iphone"]{recommended by Lifehacker}, and has hundreds of great reviews (many more than any version of Calvetica), so it must work well. The only reason I didn’t go for it was that Calvetica is faster for adding events◊link["#fn:1"]{1}, and Calvetica just looks more cool and elegant.}
◊li{◊link["http://getappsavvy.com/agenda/"]{Agenda} was ◊link["http://daringfireball.net/linked/2012/01/18/agenda"]{recommended recently on Daring Fireball} and was actually the first calendar app I used after getting our phones’ sync configured. It’s not as quick to use as Calvetica[^1], but it looks gorgeous, and swiping between month/week/day view is almost too good to give up. The app otherwise great except for one major thing: ◊strong{it’s terrible at automatic calendar syncing}, especially when an event on a shared calendar is being deleted. In my experiments Agenda would not automatically sync until I had either shut down the app and restarted it, or until I had opened the default Calendar app (which triggers its own sync). You can also use the “shake phone to sync” feature of Agenda, but honestly, all three of these things are ridiculous.}
}

◊hr{}

◊ol{
◊li{Note that if you have an iPhone 4S, you can set up new events very easily on your default calendar with Siri, no matter what app you use. ◊link["#fnref:1"]{↩}}
}
