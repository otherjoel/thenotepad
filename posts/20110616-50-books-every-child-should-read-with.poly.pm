...
◊item{◊amazon["B000JQULUE"]{◊emph{Pinocchio}} ◊color["red"]{(free)} by Carlo Collodi. What effortless invention looks like.}
◊item{◊amazon["B0045Y15UQ"]{◊emph{Emil and the Detectives}} by Erich Kastner. A great political story: democracy in action.}
◊item{◊emph{◊amazon["B00R7TESJ6"]{Swallows and Amazons}} by Arthur Ransome. As clear and pure as Mozart.}
◊item{◊amazon["B003KK5DOK"]{◊emph{Black Hearts in Battersea}} by Joan Aiken. If Ransome was Mozart, Aiken was Rossini. Unforced effervescence.}
...
◊item{◊amazon["B004IK8Q90"]{◊emph{The Phantom Tollbooth}} by Norton Juster. Superb wit and vigorous invention.}
◊item{◊emph{◊amazon["B00MLMS9SA"]{Moominsummer Madness}} by Tove Jansson. Any of the Moomin books would supply the same strange light Nordic magic.}
...
◊item{◊amazon["B003GK21NK"]{◊emph{Just William}} books by Richmal Crompton. These are a must for every child.}
◊item{◊amazon["B000JQV2K2"]{◊emph{The Happy Prince}} ◊color["red"]{(free)} by Oscar Wilde. This was the first story, I think, that ever made me cry and it still has the power to make me cry.}
◊item{◊amazon["B002ZCZ67S"]{◊emph{The Just So Stories}} by Rudyard Kipling. The story my mother used to read me most often, because I asked for it again and again. I loved the sheer fun of it, the music and the rhythm of the words. It was subversive too. Still my favourite story.}
◊item{◊amazon["B000JML7EC"]{◊emph{Treasure Island}} ◊color["red"]{(free)} by R.L. Stevenson This was the first real book I read for myself. I lived this book as I read it.}
...
◊item{◊amazon["0140345434"]{◊emph{The Singing Tree}}◊color["red"]{*} by Kate Seredy. The story of two children who go to find their father who has been listed missing in the trenches of the First World War.}
...
◊item{◊amazon["B00MLM9KQU"]{◊emph{Finn Family Moomintroll}} (and the other Moomin books) by Tove Jansson. A fantasy series for small children that introduces bigger ones to ideas of adventure, dealing with fear, understanding character and tolerating difference.}
...
◊item{◊emph{◊amazon["031231616X"]{I Capture the Castle}} by Dodie Smith. Written for a teenage audience but fun at any age.}
◊item{◊emph{◊amazon["B0026REBFK"]{The Lord of the Rings}} by J.R.R. Tolkein. Be warned, these tales of hobbits, elves and Middle Earth are dangerously addictive.}
...
◊item{◊emph{◊amazon["B00OR7XF9U"]{Carry On, Jeeves}} by P.G. Wodehouse. A grown-up book ? but not that grown-up.}
...
◊item{◊emph{◊amazon["B000UVBT3G"]{Moving Pictures}} by Terry Pratchett. Elaborate mythological imagery and a background based in real science. If you like this, the Discworld series offers plenty more.}
...
◊item{◊emph{◊amazon["B000FC1MCS"]{The Curious Incident of the Dog in the Night-Time}} by Mark Haddon. Age-transcending tale, both funny and sad.}
...
◊item{◊emph{◊amazon["B000JQUMPI"]{Little Women}} ◊color["red"]{(free)} by Louisa May Alcott. Inexplicably evergreen, trend and taste-defying 1868 classic.}
◊item{◊emph{◊amazon["1851459650"]{How to be Topp}◊color["red"]{*}} by Geoffrey Willams and Ronald Searle. Side-splitting satire on skool, oiks, teechers, fules, bulies, swots.}
◊item{◊emph{◊amazon["B000TU16GS"]{Stormbreaker}} by Anthony Horowitz. First of the action-packed adventures with 14-year-old Alex Rider.}
...
◊item{◊emph{◊amazon["0099572850"]{The Silver Sword}◊color["red"]{*}} by Ian Serraillier. Inspiring wartime story of the Balicki family in Warsaw.}
...
◊item{◊emph{◊amazon["0747589798"]{Red Cherry Red}◊color["red"]{*}} by Jackie Kay. A book of poems that reaches deep into our hidden thoughts but also talks in a joyous voice exploring the everyday.}
◊item{◊emph{◊amazon["B00358VI28"]{Talking Turkeys}} by Benjamin Zephaniah. A book of poems that demands to be read aloud, performed and thought about.}
...
◊item{◊emph{◊amazon["0670803030"]{People Might Hear You (Viking Kestrel picture books)} ◊color["red"]{*}} by Robin Klein. A profound, suspenseful story about sects, freedom and the rights of all young people --- especially girls.}
◊item{◊emph{◊amazon["B002RKSPE4"]{Noughts and Crosses}} ◊color["red"]{(free)} by Malorie Blackman. A book that dared to go where no one thought you could with young audiences because it raises tough stuff to do with race.}
...
◊item{◊emph{◊amazon["B004GTLSG6"]{After the First Death}} by Robert Cormier. Cormier is never afraid of handling how the personal meets the political all within the framework of a thriller.}
◊item{◊emph{◊amazon["B0013TPUNO"]{The London Eye Mystery}} by Siobhan Dowd. A book that allows difference to be part of the plot and not a point in itself.}
◊item{◊emph{Beano Annual.} A cornucopia of nutty, bad, silly ideas, tricks, situations and plots}
}
